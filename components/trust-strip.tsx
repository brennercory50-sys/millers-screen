  ...
  return (
    <section className="bg-bg-0 border-y border-line py-5 md:py-6">
      <div className="section-container">
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center lg:justify-between items-center gap-4 md:gap-6">
          {trustItems.map((item, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted uppercase tracking-wide leading-tight">{item.subtitle}</p>
              </div>
            </div>
          ))}
        </div>
