  ...
  return (
    <div className="group">
      ...
      >
        ...
        <div className="absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 bg-accent-red/0 opacity-0 md:group-hover:bg-accent-red md:group-hover:opacity-100 hidden md:flex">
